...
export class NewPlatformComponent implements OnInit, AfterViewInit {
  ...
  _extractBusinessContact(businessContact?: Contact) {
    ...
    businessContact.lastName = this.platformFormGroup.controls[
      "bc_fname"
    ].value;
    businessContact.firstName = this.platformFormGroup.controls[
      "bc_lname"
    ].value;
    businessContact.email = this.platformFormGroup.controls["bc_email"].value;
    businessContact.phoneNumber = this.platformFormGroup.controls[
      "bc_phone"
    ].value;
    businessContact.position = this.platformFormGroup.controls[
      "bc_position"
    ].value;
  ...
  _extractBankDetail(bankDetail?: BankDetail) {
    ...
    bankDetail.accountNumber = this.platformFormGroup.controls[
      "bankAccNumber"
    ].value;
  ...
  _extractAddress(address?: Address) {
    ...
    address.neighbourhood = this.platformFormGroup.controls[
      "neighbourhood"
    ].value;
            ...
            this._facilityService
              ...
              .then((payload: Facility) => {
                ...
                this._toastr.success(
                  "Platform has been created successfully!",
                  "Success!"
                );
                this.platformFormGroup.reset();
                this._router.navigate([
                  "/modules/platform/platforms",
                  payload._id
                ]);
              })
              .catch(err => {
