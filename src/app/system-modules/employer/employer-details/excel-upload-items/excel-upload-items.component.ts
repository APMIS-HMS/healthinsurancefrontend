...
@Component({
  selector: 'app-excel-upload-items',
  templateUrl: './excel-upload-items.component.html',
  styleUrls: ['./excel-upload-items.component.scss']
})
export class ExcelUploadItemsComponent implements OnInit {
  @Input() excelItems: any = <any>{};
