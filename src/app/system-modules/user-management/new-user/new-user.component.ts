...
import {FacilityService, GenderService, PlanTypeService, ProfessionService, SystemModuleService, UploadService, UserService, UserTypeService} from './../../../services/index';
...
export class NewUserComponent implements OnInit {
  ...
  constructor(
      ...
      private _genderService: GenderService, private _locker: CoolLocalStorage,
        ...
        this._facilityService
            .find({
              query: {
                ...
                $limit: 200,
                $select: [
                  'name', 'email', 'phoneNumber', 'facilityType', 'shortName'
                ]
              }
            })
            .then((payload: any) => {
  ...
  onClickSaveUser(valid, value: any) {
    try {
      ...
      this._toastr.error(
          'An error has occured while processing your request', 'Error');
      this._systemService.off();
    }
  }
