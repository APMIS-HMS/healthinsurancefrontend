...
export class NewHiaComponent implements OnInit {
  ...
  _initialiseFormGroup() {
    let date =
      this.selectedFacility.hia === undefined
        ? new Date()
    ...
    this.hiaFormGroup = this._fb.group({
      ...
      grade: [
        this.selectedFacility.hia != null
          ? this.selectedFacility.hia.grade
          : "",
        [<any>Validators.required]
      ],
      facilityType: [
  ...
  _extractBusinessContact(businessContact?: Contact) {
    ...
    businessContact.lastName = this.hiaFormGroup.controls[
      "businessContactName"
    ].value;
    businessContact.firstName = this.hiaFormGroup.controls[
      "businessContactFirstName"
    ].value;
    businessContact.email = this.hiaFormGroup.controls[
      "businessContactEmail"
    ].value;
    businessContact.phoneNumber = this.hiaFormGroup.controls[
      "businessContactNumber"
    ].value;
    businessContact.position = this.hiaFormGroup.controls[
      "businessContactPosition"
    ].value;
  ...
  _extractITContact(itContact?: Contact) {
    ...
    itContact.firstName = this.hiaFormGroup.controls[
      "iTContactFirstName"
    ].value;
  ...
  _extractBankDetail(bankDetail?: BankDetail) {
    ...
    bankDetail.accountNumber = this.hiaFormGroup.controls[
      "bankAccNumber"
    ].value;
  ...
  _extractHIA(hia?: HIA) {
    ...
    hia.registrationDate = this.hiaFormGroup.controls[
      "registrationDate"
    ].value.jsdate;
    return hia;
  }
  ...
  save(valid, value) {
    if (valid) {
      ...
      let facility =
        this.selectedFacility._id === undefined
