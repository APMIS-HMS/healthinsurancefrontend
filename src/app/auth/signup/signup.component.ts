...
import {FacilityService, PersonService, SystemModuleService, UserTypeService} from './../../services/index';
...
export class SignupComponent implements OnInit {
  ...
  constructor(
      ...
      private _userTypeService:
          UserTypeService)  // private _userService: UserService
  {}
  ...
  _checkEmail(value) {
    ...
    let person$ = Observable.fromPromise(this._personService.findWithOutAuth(
        {query: {email: value, platformOnwerId: this.currentPlatform._id}}));
  ...
  _checkPhoneNumber(value) {
    this._systemService.on();
    let person$ = Observable.fromPromise(this._personService.findWithOutAuth({
      query: {phoneNumber: value, platformOnwerId: this.currentPlatform._id}
    }));
    // let user$ = Observable.fromPromise(this._userService.findWithOutAuth({
